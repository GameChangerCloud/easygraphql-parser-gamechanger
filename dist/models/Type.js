...
class Type {
    ...
    static initTypes(schemaJSON) {
        ...
        for (const type in schemaJSON) {
            let typeToAdd = new Type(schemaJSON[type]['type'], type, getSQLTableName(type), schemaJSON[type]['description'], schemaJSON[type]['directives'], schemaJSON[type]['implementedTypes']);

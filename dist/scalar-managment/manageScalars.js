...
exports.getScalarFieldInfo = exports.getFieldName = exports.getFieldCreate = exports.isBasicType = exports.isScalar = void 0;
...
exports.getFieldCreate = getFieldCreate;
...
const getScalarFieldInfo = (currentType, typesNameArray) => {
    ...
    currentType.fields.forEach(field => {
        ...
        if (!typesNameArray.includes(fieldType) && field["in_model"] && (0, exports.isBasicType)(fieldType)) {
            if (fieldType === "ID") {
...
exports.getScalarFieldInfo = getScalarFieldInfo;

...
function isAdress(s) {
  return (
    s.toLowerCase().includes('street') || s.toLowerCase().includes('adress')
  )
}
function isCountry(s) {
  return (
    s.toLowerCase().includes('country') ||
...
function isFirstname(s) {
  return (
    s.toLowerCase().includes('firstname') || s.toLowerCase().includes('name')
  )
}
